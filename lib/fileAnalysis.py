...
class fileAnalysis(object):
        ...
        @staticmethod
        def identifystrings(filename, min=constants.MINIMUMSTRINGLENGTH):
        ...
        """
        def create_zip(self):
                pyminizip.compress(self.filepath, None, constants.ZIPNAME, constants.ZIPPASSWORD, 0)
        ...
        def get_yararule(self):
                rules = yara.compile(constants.DEFAULTYARARULE)
